...
export default function UserDashboard() {
  ...
  // Updated: Function to download PDF for a specific speech
  const downloadPDF = (speech) => {
    const doc = new jsPDF();  // Create a new PDF document

    doc.text(`SpeakUp Speech Report: ${speech.title}`, 10, 10);
    ...
    doc.save(`speakup_speech_${speech._id}.pdf`);  // Save as a unique file for this speech
  };
              ...
              {recentSpeeches.map((speech) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    {/* Added: Button for downloading PDF for this specific speech */}
                    <button 
                      onClick={() => downloadPDF(speech)}  // Pass the specific speech to the function
